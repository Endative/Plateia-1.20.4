...
public class CalciteWireBlock extends Block {
    ...
    public static final int field_31222 = 1;
    public static final int field_31223 = 3;
    public static final int field_31224 = 13;
    public static final int field_31225 = 3;
    public static final int field_31226 = 13;
    public static final VoxelShape DOT_SHAPE;
    public static final Map<Direction, VoxelShape> DIRECTION_TO_SIDE_SHAPE;
    public static final Map<Direction, VoxelShape> DIRECTION_TO_UP_SHAPE;
    public static final Map<BlockState, VoxelShape> SHAPES;
    public static final Vec3d[] COLORS;
    public static final float field_31221 = 0.2F;
    public final BlockState dotState;
    public boolean wiresGivePower = true;

    public static final BooleanProperty CORNER0 = BooleanProperty.of("corner0");

    public CalciteWireBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public BlockState getPlacementState(BlockView world, BlockState state, BlockPos pos) {
    ...
    public BlockState getDefaultWireState(BlockView world, BlockState state, BlockPos pos) {
    ...
    public static boolean isFullyConnected(BlockState state) {
    ...
    public static boolean isNotConnected(BlockState state) {
        return !((WireConnection)state.get(WIRE_CONNECTION_NORTH)).isConnected() && !((WireConnection)state.get(WIRE_CONNECTION_SOUTH)).isConnected() && !((WireConnection)state.get(WIRE_CONNECTION_EAST)).isConnected() && !((WireConnection)state.get(WIRE_CONNECTION_WEST)).isConnected();
    }
    ...
    public WireConnection getRenderConnectionType(BlockView world, BlockPos pos, Direction direction) {
        return this.getRenderConnectionType(world, pos, direction, !world.getBlockState(pos.up()).isSolidBlock(world, pos));
    }

    public WireConnection getRenderConnectionType(BlockView world, BlockPos pos, Direction direction, boolean bl) {
    ...
    public boolean canRunOnTop(BlockView world, BlockPos pos, BlockState floor) {
        return floor.isSideSolidFullSquare(world, pos, Direction.UP) || floor.isOf(Blocks.HOPPER);
    }

    public void update(World world, BlockPos pos, BlockState state) {
        int i = this.getReceivedCustomPower(world, pos);
    ...
    public int getReceivedCustomPower(World world, BlockPos pos) {
    ...
    public int increasePower(BlockState state) {
    ...
    public static boolean connectsTo(BlockState state, @Nullable Direction dir) {
        if (state.isOf(ModBlocks.CALCITE_WIRE)) {
            return true;
        } else if (state.isOf(ModBlocks.DOUBLE_CALCITE_WIRE)) {
            return true;
    ...
    public boolean emitsCustomPower(BlockState state) {
    ...
    public void updateForNewState(World world, BlockPos pos, BlockState oldState, BlockState newState) {
        Iterator var5 = Type.HORIZONTAL.iterator();
